...
let url = 'https://apiframeworks.herokuapp.com/'
...
busqueda.addEventListener('click', function(e){
    ...
    if(search.value === null || search.value === ''){
        ...
        url = 'https://apiframeworks.herokuapp.com/'
        
    }else{

        url = 'https://apiframeworks.herokuapp.com/?id='+search.value
...
function mostrar(id){
    ...
    url = 'https://apiframeworks.herokuapp.com/?id='+id
    fetch(url)
    .then(response => response.json())
    .then(json => {
